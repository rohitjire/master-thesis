...
identity stack enabled -- and each is rendered over the exact measured window recorded in
that run's provenance file. One connector is shown rather than all three because the
purpose is to illustrate the instrument, not to repeat the comparison.
