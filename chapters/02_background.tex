...
This chapter establishes the technical and conceptual vocabulary the rest of the thesis assumes. \Cref{sec:data-spaces-ids} introduces dataspaces and the \gls{ids} initiative, \cref{sec:dsp} describes the \gls{dsp}, and \cref{sec:connectors} presents the connector implementations that this work compares. \Cref{sec:performance-concepts,sec:benchmarking-fundamentals} then define what performance and benchmarking mean in this setting.
